...
//#define CXX_XOR_PROJECT_USE_UINTPTR_T
...
int main() {
    ...
    dllist<int> dl_size_val(3U, int{5});
    ...
    dllist<int> dl_list_init{ {1, 2, 3, 4, 5, 6} };
    ...
    dllist<int> dl_copy{dl_list_init};
    ...
    dllist<int> dl_move{ dllist<int>{ {1, 2, 3, 4, 5} } };
    ...
    std::cout << " = move test: ";
    dllist<int> dl_equal_move = dllist<int>{ {1, 2, 3, 4, 5} };
    ...
    dllist<int> dl_assign_init_list;
    ...
    //testing size()
    dllist<int> size_test{ {1, 2, 3, 4, 5} };
    ...
    //testing max_size()
    dllist<int> max_size_test{ {1, 2, 3, 4, 5} };
    ...
    //testing front()
    dllist<int> front_test{ {2, 1, 3, 4, 5} };
    ...
    //testing insert()
    dllist<int> insert_test { {3, 2, 1, 4 } };
    ...
    dllist<int> b1 { {1, 2, 3, 4, 5} };
    dllist<int> b2 { {1, 2, 3, 4, 5} };
    ...
    dllist<int> dl_iter_init{dl_list_init.begin(), dl_list_init.end()};
